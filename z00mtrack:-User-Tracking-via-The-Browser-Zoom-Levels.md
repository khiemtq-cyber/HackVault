...
You might expect the ratio to be consistent across browsers, but on my testing machine at a 110% zoom level, the ratio was different between Firefox and Chrome—`1.100000023841858` and `1.0909090909090908` respectively. After some Googling, I found a small list of sample values for the `window.devicePixelRatio` in this GitHub gist "https://gist.github.com/cheeaun/8838438".
